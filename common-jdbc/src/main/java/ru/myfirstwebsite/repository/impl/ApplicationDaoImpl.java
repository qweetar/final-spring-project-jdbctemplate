...
public class ApplicationDaoImpl implements ApplicationDao {
    ...
    public Application save(Application entity) {
       final String creatQuery = "insert into application (roomSize, room_class, datefrom, dateto, user_iduser) " +
               "VALUES (:roomSize, :roomClass, : dateFrom, :dateTo, userId);";
    ...
    public Application update(Application entity) {
        final String createQuery = "update application set roomsize = :roomSize, " +
                "room_class = :roomClass, datefrom = :dateFrom, dateto = :dateTo, " +
                "user_iduser = :userId where idapplication = :applicationId";
