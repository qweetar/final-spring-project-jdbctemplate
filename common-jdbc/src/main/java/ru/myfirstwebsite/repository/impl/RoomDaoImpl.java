...
public class RoomDaoImpl implements RoomDao {
    ...
    public Room save(Room entity) {
        final String createQuery = "insert into room (roomnum, roomsize, room_class, priceday, roomstatus) " +
    ...
    public Room update(Room entity) {
        final String createQuery = "update room set roomnum = :roomNum, roomsize = :roomSize, " +
                "room_class = :roomClass, priceday = :roomPricePerDay, roomStatus = :roomStatus " +
                "where idroom = :roomId";
